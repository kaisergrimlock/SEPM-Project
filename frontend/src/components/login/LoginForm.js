        ...
        <div className='border border-black py-5 px-10 rounded-lg bg-white'>
          ...
          <h1 className='pt-3 pb-1 text-2xl font-bold border-b-4 border-black inline-block w-fit'>Login</h1>
              <div className='my-3'>
                  ...
                  <input type="email" id="email" name="email" {...register("email", loginValidation.email)} placeholder='Enter your email'/>
              </div>
    
              <div className='my-3'>
                  <label htmlFor="password" className='font-semibold'>Password: </label>
                  <input type="password" id="password" name="password" {...register("password", loginValidation.password)} placeholder='Enter your password'/>
              </div>
